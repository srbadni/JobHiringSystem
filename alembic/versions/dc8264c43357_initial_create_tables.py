...
Revision ID: dc8264c43357
Revises: 
Create Date: 2026-09-05 16:31:20.966843
...
def upgrade() -> None:
    ...
    op.create_table('attached_resumes',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('profile_id', sa.Uuid(), nullable=False),
    sa.Column('minimum_salary_range_id', sa.Uuid(), nullable=True),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('company_id', sa.Uuid(), nullable=False),
    sa.Column('job_category_id', sa.Uuid(), nullable=False),
    sa.Column('province_id', sa.Uuid(), nullable=False),
    sa.Column('city_id', sa.Uuid(), nullable=False),
    ...
    sa.Column('salary_range_id', sa.Uuid(), nullable=False),
    ...
    sa.Column('job_preference_id', sa.Uuid(), nullable=False),
    ...
    sa.Column('status', sa.Enum('SENT_TO_EMPLOYER', 'REVIEWED', 'INTERVIEW', 'HIRED', 'OTHER', name='application_status'), nullable=False),
    sa.ForeignKeyConstraint(['applicant_id'], ['users.id'], ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.drop_table('attached_resumes')
